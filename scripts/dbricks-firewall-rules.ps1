...
$netRules += new-AzFirewallNetworkRule -Name "webapp_3" -SourceAddress $dbricksVnet -DestinationAddress "20.73.215.48/28" -DestinationPort 443 -Protocol TCP -Description "Allow access to Databricks Extended infra."
...
$netRules += new-AzFirewallNetworkRule -Name "metastore_3" -SourceAddress $dbricksVnet -DestinationFqdn "consolidated-westeurope-prod-metastore-addl-2.mysql.database.azure.com" -DestinationPort 3306 -Protocol TCP -Description "Allow access to Databricks metastore"
$netRules += new-AzFirewallNetworkRule -Name "metastore_4" -SourceAddress $dbricksVnet -DestinationFqdn "consolidated-westeurope-prod-metastore-addl-3.mysql.database.azure.com" -DestinationPort 3306 -Protocol TCP -Description "Allow access to Databricks metastore"
$netRules += new-AzFirewallNetworkRule -Name "metastore_5" -SourceAddress $dbricksVnet -DestinationFqdn "consolidated-westeuropec2-prod-metastore-0.mysql.database.azure.com" -DestinationPort 3306 -Protocol TCP -Description "Allow access to Databricks metastore"
$netRules += new-AzFirewallNetworkRule -Name "metastore_6" -SourceAddress $dbricksVnet -DestinationFqdn "consolidated-westeuropec2-prod-metastore-1.mysql.database.azure.com" -DestinationPort 3306 -Protocol TCP -Description "Allow access to Databricks metastore"
$netRules += new-AzFirewallNetworkRule -Name "metastore_7" -SourceAddress $dbricksVnet -DestinationFqdn "consolidated-westeuropec2-prod-metastore-2.mysql.database.azure.com" -DestinationPort 3306 -Protocol TCP -Description "Allow access to Databricks metastore"
$netRules += new-AzFirewallNetworkRule -Name "metastore_8" -SourceAddress $dbricksVnet -DestinationFqdn "consolidated-westeuropec2-prod-metastore-3.mysql.database.azure.com" -DestinationPort 3306 -Protocol TCP -Description "Allow access to Databricks metastore"
